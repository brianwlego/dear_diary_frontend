...
class Profile extends React.Component {
    ...
    profileUserFetch = () => {
        ...
        fetch(`https://notfcebook-backend.herokuapp.com/api/v1/users/${profileId}/profile`, configObj)
            .then(resp => resp.json())
            .then(profile => {
                this.setState(() => ({
                    posts: profile.posts,
    ...
    submitHandler = () => {
        if (this.state.editPostObj) {
            ...
            fetch(`https://notfcebook-backend.herokuapp.com/api/v1/posts/${this.state.editPostObj.id}`, configObj)
                .then(resp => resp.json())
                .then(updatedPost => {
    ...
    follow = () => {
        ...
        fetch(`https://notfcebook-backend.herokuapp.com/api/v1/users/${this.props.user.id}/follow`, configObj)
            .then(resp => resp.json())
            .then(message => {
                if (message.success) {
                    const u = {
    ...
    unfollow = () => {
        ...
        fetch(`https://notfcebook-backend.herokuapp.com/api/v1/users/${this.props.user.id}/unfollow`, configObj)
            .then(resp => resp.json())
            .then(message => {
                if (message.success) {
    ...
    deletePost = (postObj) => {
        ...
        fetch(`https://notfcebook-backend.herokuapp.com/api/v1/posts/${postObj.id}`, configObj)
            .then(resp => resp.json())
            .then(message => {
                if (message.success) {
