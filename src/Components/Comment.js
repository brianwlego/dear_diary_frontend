...
export default class Comment extends React.Component {
    ...
    commentAddLike = (commentObj) => {
        ...
        fetch(`https://notfcebook-backend.herokuapp.com/api/v1/posts/${this.state.comment.post_id}/comments/${this.state.comment.id}/like`, configObj)
            .then(resp => resp.json())
            .then(comment => {
                this.setState(() => ({
    ...
    commentRemoveLike = (likeObj) => {
        ...
        fetch(`https://notfcebook-backend.herokuapp.com/api/v1/posts/${this.state.comment.post_id}/comments/${this.state.comment.id}/unlike/${foundCommentLike.id}`, configObj)
            .then(resp => resp.json())
